...
<head>
    ...
    <!-- 使用url函数转换相关路径 -->
    <link rel="stylesheet" href="<?php echo $staticResource->css['bootstrap']; ?>">
    ...
    <script src="<?php echo $staticResource->js['iconfont']; ?>" crossorigin="anonymous"></script>
    <script src="<?php echo $staticResource->js['bootstrap']; ?>" crossorigin="anonymous"></script>
    <!-- 通过自有函数输出HTML头部信息 -->
    <?php $this->header(); ?>
</head>
<body>